...
select 'SCRIPT_HOME/ddsc_db_undo.txt'    na03 from dual;
select 'SCRIPT_HOME/ddsc_db_lib.txt'     na09 from dual;
select 'SCRIPT_HOME/ddsc_db_pga.txt'     na11 from dual;
select 'SCRIPT_HOME/ddsc_db_sess.txt'    na13 from dual;
--select 'SCRIPT_HOME/ddsc_db_sgacom.txt'  na14 from dual;
select 'SCRIPT_HOME/ddsc_db_share.txt'   na16 from dual;
select 'SCRIPT_HOME/ddsc_db_sysstat.txt' na17 from dual;
select 'SCRIPT_HOME/ddsc_db_dict.txt'    na18 from dual;
select 'SCRIPT_HOME/ddsc_db_temp.txt'    na19 from dual;
