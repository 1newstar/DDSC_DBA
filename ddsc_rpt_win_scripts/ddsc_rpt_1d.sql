...
select 'DATA_DIR\ddsc_db_size.txt'    na01 from dual;
select 'DATA_DIR\ddsc_db_tbs.txt'     na02 from dual;
select 'DATA_DIR\ddsc_db_df.txt'      na04 from dual;
select 'DATA_DIR\ddsc_db_inst.txt'    na05 from dual;
select 'DATA_DIR\ddsc_db_par.txt'     na06 from dual;
select 'DATA_DIR\ddsc_db_idx.txt'     na07 from dual;
select 'DATA_DIR\ddsc_db_obj.txt'     na08 from dual;
select 'DATA_DIR\ddsc_db_logsw.txt'   na10 from dual;
select 'DATA_DIR\ddsc_db_seg.txt'     na12 from dual;
select 'DATA_DIR\ddsc_db_sgars.txt'   na15 from dual;
select 'DATA_DIR\ddsc_db_bak.txt'     na19 from dual;
